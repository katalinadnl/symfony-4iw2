 ...
 */
final class Version20241126152533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ALTER COLUMN release_date TYPE TIMESTAMP(0)');
        ...
        $this->addSql('ALTER TABLE playlist ALTER created_at TYPE TIMESTAMP(0) USING release_date::timestamp(0) without time zone');
